...
EOF
azure group deployment create --resource-group ${rg_name} --name "create-application-gateway" --template-file ./bosh-cpi-src/ci/assets/azure/application-gateway.json --parameters-file ./application-gateway-parameters.json
