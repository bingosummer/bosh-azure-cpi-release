...
module Bosh::AzureCloud
  ...
  class VMCloudProps
    ...
    def initialize(vm_properties, global_azure_config)
      ...
      cloud_error("The cloud property 'instance_type' is missing. Alternatively you can specify 'vm_resources' key. https://bosh.io/docs/manifest-v2/#instance-groups") if @instance_type.nil? && @instance_types.empty?
