...
describe Bosh::AzureCloud::AzureClient2 do
  ...
  describe "#check_storage_account_name_availability" do
    let(:storage_account_name_uri) { "https://management.azure.com//subscriptions/#{subscription_id}/resourceGroups/#{resource_group_name}?api-version=#{group_api_version}" }
