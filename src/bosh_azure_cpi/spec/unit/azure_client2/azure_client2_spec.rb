  ...
  describe "#get_resource_by_id" do
    ...
    context "when token is invalid" do
      ...
      it "should raise an error if tenant_id, client_id or client_secret/certificate is invalid" do
        ...
        expect {
          azure_client2.get_resource_by_id(url, { 'api-version' => api_version })
        }.to raise_error /get_token - http code: 401. Azure authentication failed: Invalid tenant_id, client_id or client_secret\/certificate./
      end
      ...
      it "should raise an error if the request is invalid" do
        ...
        expect {
          azure_client2.get_resource_by_id(url, { 'api-version' => api_version })
        }.to raise_error /get_token - http code: 400. Azure authentication failed: Bad request. Please assure no typo in values of tenant_id, client_id or client_secret\/certificate./
      end
