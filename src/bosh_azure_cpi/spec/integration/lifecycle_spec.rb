...
describe Bosh::AzureCloud::Cloud do
  before(:all) do
    ...
    @resource_group_name_1  = ENV['BOSH_AZURE_RESOURCE_GROUP_NAME_1']   || raise("Missing BOSH_AZURE_RESOURCE_GROUP_NAME_1")
    @resource_group_name_2  = ENV['BOSH_AZURE_RESOURCE_GROUP_NAME_2']   || raise("Missing BOSH_AZURE_RESOURCE_GROUP_NAME_2")
    @public_ip_1            = ENV['BOSH_AZURE_PUBLIC_IP_1']             || raise("Missing BOSH_AZURE_PUBLIC_IP_1")
    @public_ip_2            = ENV['BOSH_AZURE_PUBLIC_IP_2']             || raise("Missing BOSH_AZURE_PUBLIC_IP_2")
